...
GKE_CLUSTER_NAME_DEFAULT="v5e-256-bodaborg-europe-west4" # Default cluster name using system username
...
TPU_NODEPOOL_NAME_DEFAULT="v5e-256-bodaborg-europe-west4-np-0"
TPU_TOPOLOGY_DEFAULT="16x16"
TPU_MACHINE_TYPE_DEFAULT="ct5lp-hightpu-4t"
USE_SPOT_TPU_DEFAULT="true" # Default to using Spot VMs for TPUs
AXLEARN_CONFIG_PATH_DEFAULT="/google/src/cloud/rishibathina/rishisandbox/google3/apple_pathways_subslicing/axlearn/.axlearn" # Use $HOME which bash expands
ARTIFACT_REPO_NAME="axlearn"
ARTIFACT_REPO_LOCATION="us"
JOBSET_VERSION="v0.8.1"

# Use environment variables if set, otherwise use defaults
GKE_CLUSTER_NAME="$GKE_CLUSTER_NAME_DEFAULT"
